...
Future<void> violationSummaryPerViolationExportToCSV(
    BuildContext context) async {
  try {
    // 🔹 Fetch data from Firestore from the 'violation_summary' collection
    final querySnapshot = await FirebaseFirestore.instance
        .collection('violation_summary_per_violation')
        .get();
    ...
    for (var doc in querySnapshot.docs) {
      ...
      csvData.add([
        ...
        data['violation_name'] ?? 'NOT FOUND',
        data['violation_section'] ?? 'NOT FOUND',
    ...
    final anchor = html.AnchorElement(href: url)
      ..style.display = 'none'
      ..download =
          'violation_summary_per_violation_export_${DateTime.now().millisecondsSinceEpoch}.csv';
