...
import 'enforcer_assignment_modal_model.dart';
...
class EnforcerAssignmentModalWidget extends StatefulWidget {
  ...
  State<EnforcerAssignmentModalWidget> createState() =>
      _EnforcerAssignmentModalWidgetState();
}

class _EnforcerAssignmentModalWidgetState
    extends State<EnforcerAssignmentModalWidget> {
  late EnforcerAssignmentModalModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EnforcerAssignmentModalModel());
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: StreamBuilder<List<ApprePlacesRecord>>(
        ...
        builder: (context, snapshot) {
          ...
          List<ApprePlacesRecord> assignmentModalApprePlacesRecordList =
              snapshot.data!;
                                                              ...
                                                              builder:
                                                                ...
                                                                return AlertDialog(
                                                                  title: Text(
                                                                      'Are you sure?'),
                                                                  content: Text(
                                                                      'Assign this place to the selected enforcer?'),
                                                                  actions: [
                                                                    TextButton(
