...
class AddApprePlaceWidget extends StatefulWidget {
  const AddApprePlaceWidget({super.key});

  @override
  State<AddApprePlaceWidget> createState() => _AddApprePlaceWidgetState();
}

class _AddApprePlaceWidgetState extends State<AddApprePlaceWidget> {
  late AddApprePlaceModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddApprePlaceModel());

    _model.landmarkTextController ??= TextEditingController();
    _model.landmarkFocusNode ??= FocusNode();

    _model.barangayTextController ??= TextEditingController();
    _model.barangayFocusNode ??= FocusNode();

    _model.purokTextController ??= TextEditingController();
                                      ...
                                      return Dialog(
                                        ...
                                        child: ConfirmModalWidget(
                                          ...
                                          primaryButtonAction: () async {
                                            await ApprePlacesRecord.collection
                                                .doc()
                                                .set(
                                                    createApprePlacesRecordData(
                                                  barangay: _model
                                                      .barangayTextController
                                                      .text,
                                                  purok: _model
                                                      .purokTextController.text,
                                                  street: _model
