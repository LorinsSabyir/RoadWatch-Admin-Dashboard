...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? NavBarPage() : MainDashboardWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'main_AnalyticsCopy')
              : MainAnalyticsCopyWidget(),
        ),
        FFRoute(
          name: KjWidget.routeName,
          path: KjWidget.routePath,
          builder: (context, params) => KjWidget(),
        )
