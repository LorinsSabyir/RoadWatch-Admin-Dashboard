                                                          ...
                                                          Padding(
                                                            ...
                                                            child: Container(
                                                              ...
                                                              child:
                                                                ...
                                                                barData: [
                                                                  FFBarChartData(
                                                                    yData: graphMonthlySummaryRecordList
                                                                        .where((e) =>
                                                                            e.year ==
                                                                            _model
                                                                ...
                                                                xLabels: graphMonthlySummaryRecordList
                                                                    .where((e) =>
                                                                        e.year ==
                                                                        _model
                                                                            .violationChartYearFilterValue)
                                        ...
                                        Container(
                                          ...
                                          child: StreamBuilder<
                                            ...
                                            builder: (context, snapshot) {
                                              ...
                                              List<MonthlySummaryRecord>
                                                  violationTableMonthlySummaryRecordList =
                                                  snapshot.data!;
                                              // Return an empty Container when the item does not exist.
                                              if (snapshot.data!.isEmpty) {
                                                return Container();
                                              }
                                              final violationTableMonthlySummaryRecord =
                                                  violationTableMonthlySummaryRecordList
                                                          .isNotEmpty
                                                      ? violationTableMonthlySummaryRecordList
                                                          .first
                                                              ...
                                                              Expanded(
                                                                ...
                                                                child: Builder(
                                                                  builder:
                                                                      (context) {
                                                                    final violationName =
                                                                        violationTableMonthlySummaryRecord?.violationName.toList() ??
                                                                            [];
                                                                ...
                                                                child: Builder(
                                                                  builder:
                                                                    ...
                                                                    final violationCount =
                                                                        violationTableMonthlySummaryRecord?.violationCount.toList() ??
                                                                            [];
                                                                    ...
                                                                    return ListView
                                                                      ...
                                                                      itemBuilder:
                                                                          (context,
                                                                              violationCountIndex) {
                                                                        final violationCountItem =
                                                                            violationCount[violationCountIndex];
                                                                        return Visibility(
                                                                          visible:
                                                                ...
                                                                Expanded(
                                                                  ...
                                                                  child: Align(
                                                                    ...
                                                                    child: Text(
                                                                      valueOrDefault<
                                                                          String>(
                                                                        violationTableMonthlySummaryRecord
                                                                            ?.totalViolations
                                                                            .toString(),
                                                                        '0',
                                                                      ),
