                                          ...
                                          child: Padding(
                                            ...
                                            child: Container(
                                              ...
                                              child: Padding(
                                                ...
                                                child: StreamBuilder<
                                                    List<
                                                        AnnualCitationChartRecord>>(
                                                  stream:
                                                      queryAnnualCitationChartRecord(
                                                    queryBuilder:
                                                        (annualCitationChartRecord) =>
                                                            annualCitationChartRecord
                                                                .where(
                                                  ...
                                                  builder: (context, snapshot) {
                                                    ...
                                                    List<AnnualCitationChartRecord>
                                                        chartAnnualCitationChartRecordList =
                                                        snapshot.data!;
                                      ...
                                      children: [
                                            ...
                                            children: [
                                              ...
                                              Row(
                                                ...
                                                children: [
                                                  FlutterFlowDropDown<String>(
                                                    controller: _model
                                                            .violationTableMonthFilterValueController ??=
                                                        FormFieldController<
                                                            String>(
                                                      _model.violationTableMonthFilterValue ??=
                                                          dateTimeFormat("MMMM",
                                                              getCurrentTimestamp),
                                                    ),
                                                    options: [
                                                    ...
                                                    onChanged: (val) async {
                                                      safeSetState(() => _model
                                                              .violationTableMonthFilterValue =
                                                          val);
                                                      safeSetState(() {});
                                                    },
                                                    width: 130.0,
                                        ...
                                        StreamBuilder<
                                          ...
                                          builder: (context, snapshot) {
                                            ...
                                            List<MonthlySummaryRecord>
                                                tableContentMonthlySummaryRecordList =
                                                snapshot.data!;
                                            // Return an empty Container when the item does not exist.
                                            if (snapshot.data!.isEmpty) {
                                              return Container();
                                            }
                                            final tableContentMonthlySummaryRecord =
                                                tableContentMonthlySummaryRecordList
                                                        .isNotEmpty
                                                    ? tableContentMonthlySummaryRecordList
                                                        .first
                                                  ...
                                                  children: [
                                                    Expanded(
                                                      ...
                                                      child: Builder(
                                                        builder: (context) {
                                                          final violationName =
                                                              tableContentMonthlySummaryRecord
                                                                      ?.violationName
                                                                      .toList() ??
                                                                  [];
