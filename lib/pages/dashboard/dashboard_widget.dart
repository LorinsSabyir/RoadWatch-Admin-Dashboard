...
class _DashboardWidgetState extends State<DashboardWidget>
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<CitationRecord>>(
      future: queryCitationRecordOnce(
        queryBuilder: (citationRecord) => citationRecord.where(
          'appre_date_year',
          isEqualTo: dateTimeFormat("yyyy", getCurrentTimestamp),
        ),
      ),
      builder: (context, snapshot) {
        ...
        List<CitationRecord> dashboardCitationRecordList = snapshot.data!;
                                      ...
                                      child: FutureBuilder<int>(
                                        ...
                                        builder: (context, snapshot) {
                                          ...
                                          return wrapWithModel(
                                            model: _model.totalCitationModel,
                                            updateCallback: () =>
                                                safeSetState(() {}),
                                            child: DashboardCardWidget(
                                              cardTitle: 'Total Citations',
                                              cardValue: totalCitationCount,
                                              cardTrend: Icon(
                                                Icons.trending_up,
                                                color:
                                                    FlutterFlowTheme.of(context)
