                                                                                ...
                                                                                child: Stack(
                                                                                  children: [
                                                                                    FlutterFlowBarChart(
                                                                                      barData: [
                                                                                        FFBarChartData(
                                                                                          yData: perBarangayGraphViolationSummaryPerBrgyRecordList.where((e) => (e.year == _model.violationChartYearFilterValue) && (e.month == _model.violationChartMonthFilterValue)).toList().sortedList(keyOf: (e) => e.actualViolations, desc: true).map((d) => d.actualViolations).toList(),
                                                                                          color: FlutterFlowTheme.of(context).tertiary,
                                                                                          borderWidth: 2.0,
                                                                                          borderColor: FlutterFlowTheme.of(context).primary,
                                                                                        ),
                                                                                        FFBarChartData(
                                                                                          yData: perBarangayGraphViolationSummaryPerBrgyRecordList.where((e) => (e.year == _model.violationChartYearFilterValue) && (e.month == _model.violationChartMonthFilterValue)).toList().sortedList(keyOf: (e) => e.actualViolations, desc: true).map((d) => d.forecastedViolations).toList(),
                                                                                          color: FlutterFlowTheme.of(context).success,
                                                                                          borderWidth: 2.0,
                                                                                          borderColor: Color(0xFF1A6F61),
                                                                                        )
                                                                                      ],
                                                                                      xLabels: perBarangayGraphViolationSummaryPerBrgyRecordList.where((e) => (e.year == _model.violationChartYearFilterValue) && (e.month == _model.violationChartMonthFilterValue)).toList().sortedList(keyOf: (e) => e.actualViolations, desc: true).map((d) => d.barangay).toList(),
                                                                                      stacked: true,
                                                                                      barWidth: 32.0,
                                                                                      ...
                                                                                      xAxisLabelInfo: AxisLabelInfo(
                                                                                        title: 'Top 5 Barangay of most violations',
                                                                                      ...
                                                                                      yAxisLabelInfo: AxisLabelInfo(
                                                                                        title: 'Total Number of Violation',
                                                                                        titleTextStyle: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                              font: GoogleFonts.plusJakartaSans(
                                                                                                fontWeight: FlutterFlowTheme.of(context).bodyMedium.fontWeight,
                                                                                                fontStyle: FlutterFlowTheme.of(context).bodyMedium.fontStyle,
                                                                                ...
                                                                                child: Stack(
                                                                                  children: [
                                                                                    FlutterFlowBarChart(
                                                                                      barData: [
                                                                                        FFBarChartData(
                                                                                          yData: perViolationGraphViolationSummaryPerViolationRecordList
                                                                                              .where((e) => valueOrDefault<bool>(
                                                                                                    (e.year == _model.violationChartYearFilterValue) && (e.month == _model.violationChartMonthFilterValue),
                                                                                                    true,
                                                                                                  ))
                                                                                              .toList()
                                                                                              .sortedList(keyOf: (e) => e.totalOccurrences, desc: true)
                                                                                              .map((d) => d.totalOccurrences)
                                                                                              .toList(),
                                                                                          color: FlutterFlowTheme.of(context).tertiary,
                                                                                          borderWidth: 2.0,
                                                                                          borderColor: FlutterFlowTheme.of(context).primary,
                                                                                        ...
                                                                                        FFBarChartData(
                                                                                          yData: perViolationGraphViolationSummaryPerViolationRecordList
                                                                                              ...
                                                                                              .toList()
                                                                                              .sortedList(keyOf: (e) => e.totalOccurrences, desc: true)
                                                                                              .map((d) => d.totalForecastedOccurrences)
                                                                                              .toList(),
                                                                                          color: FlutterFlowTheme.of(context).success,
                                                                                          borderWidth: 2.0,
                                                                                          borderColor: Color(0xFF1A6F61),
                                                            ...
                                                            child: Builder(
                                                              builder:
                                                                ...
                                                                return FlutterFlowDataTable<
                                                                  ...
                                                                  dataRowBuilder: (perViolationSummaryItem,
                                                                    ...
                                                                    cells: [
                                                                      ...
                                                                      Align(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          valueOrDefault<
                                                                              String>(
                                                                            perViolationSummaryItem.totalOccurrences.toString(),
                                                                            '0',
                                                                          ),
                                                                          textAlign:
                                                                              TextAlign.center,
                                                                        ...
                                                                        children: [
                                                                          Align(
                                                                            ...
                                                                            child:
                                                                                Text(
                                                                              valueOrDefault<String>(
                                                                                perViolationSummaryItem.variance.toString(),
                                                                                '0',
                                                                              ),
                                                                              textAlign: TextAlign.center,
                                                                              style: FlutterFlowTheme.of(context).titleLarge.override(
                                                                      ...
                                                                      Align(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          valueOrDefault<
                                                                              String>(
                                                                            perViolationSummaryItem.totalForecastedOccurrences.toString(),
                                                                            '0',
                                                                          ),
                                                                          textAlign:
                                                                              TextAlign.center,
