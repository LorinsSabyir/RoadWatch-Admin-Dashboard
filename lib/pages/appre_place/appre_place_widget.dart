...
import '/modals/add_appre_place/add_appre_place_widget.dart';
import '/modals/edit_appre_place/edit_appre_place_widget.dart';
...
import 'appre_place_model.dart';
export 'appre_place_model.dart';

class ApprePlaceWidget extends StatefulWidget {
  const ApprePlaceWidget({super.key});

  static String routeName = 'ApprePlace';
  static String routePath = '/apprePlace';
...
class _ApprePlaceWidgetState extends State<ApprePlaceWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ApprePlaceModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<ApprePlacesRecord>>(
      stream: FFAppState().apprePlacePageCache(
        requestFn: () => queryApprePlacesRecord(),
      ),
      builder: (context, snapshot) {
        ...
        List<ApprePlacesRecord> apprePlaceApprePlacesRecordList =
            snapshot.data!;
                                    ...
                                    children: [
                                      Column(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            'Below is the compiled record of places where apprehensions occurred.',
                                            style: FlutterFlowTheme.of(context)
                                                .labelMedium
                                                .override(
                                                  font: GoogleFonts
                                      ...
                                      FFButtonWidget(
                                        onPressed: () async {
                                          await actions.apprePlaceExportToCSV(
                                            context,
                                          );
                                        },
                                        text: 'Download CSV',
                                                                                  ...
                                                                                  child: ConfirmModalWidget(
                                                                                    ...
                                                                                    primaryButtonAction: () async {
                                                                                      ...
                                                                                      await adminNotifRecordReference.set(createAdminNotifRecordData(
                                                                                        title: 'Place of Apprehension Deleted.',
                                                                                        subtitle: 'Place & apprehension successfully deleted.',
                                                                                        type: 'history',
                                                                                        status: 'static',
                                                                                        createdTime: getCurrentTimestamp,
                                                                                        notifType: 'ViolationEdit',
                                                                                        adminId: currentUserReference,
                                                                                        apprePlaceId: noSearchItem.reference,
                                                                                      ));
                                                                                      _model.apprePlaceDeleteNotif = AdminNotifRecord.getDocumentFromData(
                                                          ...
                                                          Row(
                                                            ...
                                                            children: [
                                                              ...
                                                              Expanded(
                                                                flex: 3,
                                                                child: Text(
                                                                  '${searchItem.landmark}, ${searchItem.barangay}, ${searchItem.purok}, ${searchItem.street}',
                                                                  style: FlutterFlowTheme.of(
                                                                          context)
                                                                      .titleLarge
                                                                      .override(
                                                                            ...
                                                                            builder:
                                                                              ...
                                                                              return Dialog(
                                                                                ...
                                                                                child: GestureDetector(
                                                                                  ...
                                                                                  child: EditApprePlaceWidget(
                                                                                    apprePlaceRef: searchItem.reference,
                                                                                  ),
                                                                                ),
                                                                              );
                                                                            },
                                                                                  ...
                                                                                  child: ConfirmModalWidget(
                                                                                    ...
                                                                                    primaryButtonAction: () async {
                                                                                      ...
                                                                                      await adminNotifRecordReference.set(createAdminNotifRecordData(
                                                                                        ...
                                                                                        notifType: 'ViolationEdit',
                                                                                        adminId: currentUserReference,
                                                                                        apprePlaceId: searchItem.reference,
                                                                                      ));
                                                                                      _model.apprePlaceDeleteSearchNotif = AdminNotifRecord.getDocumentFromData(
                                                                                          createAdminNotifRecordData(
                                                                                            title: 'Place of Apprehension Deleted.',
                                                                                            subtitle: 'Place & apprehension successfully deleted.',
                                                                                            type: 'history',
