  ...
  Widget build(BuildContext context) {
    return StreamBuilder<ApprePlacesRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final assignmentModalApprePlacesRecord = snapshot.data!;
                            ...
                            children: [
                              Container(
                                ...
                                child: TextFormField(
                                  controller: _model.landmarkTextController ??=
                                    ...
                                    text: assignmentModalApprePlacesRecord
                                        .landmark,
                                  ),
                              ...
                              Container(
                                ...
                                child: TextFormField(
                                  ...
                                  keyboardType: TextInputType.emailAddress,
                                  validator: _model
                                      .barangayTextControllerValidator
                                      .asValidator(context),
                                ),
                              ),
                              Container(
                                ...
                                child: TextFormField(
                                  controller: _model.purokTextController ??=
                                      TextEditingController(
                                    text:
                                        assignmentModalApprePlacesRecord.purok,
                                  ),
                              ...
                              Container(
                                ...
                                child: TextFormField(
                                  controller: _model.streetTextController ??=
                                      TextEditingController(
                                    text:
                                        assignmentModalApprePlacesRecord.street,
                                  ),
